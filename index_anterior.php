...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="fs-6 text-end mb-2 mr-2">
                <span style="color:#AAECFF" class="fs-6">&#9632</span><span> Justificada </span><span style="color:#AAFFBE" class="fs-6">&#9632</span><span> Definitiva </span><span class="text-danger fs-6">&#9632</span><span> Plazo justificación </span><span class="text-warning fs-6">&#9632</span><span> Aviso presentar </span><span class="text-dark fs-6">&#9632</span><span> Aviso espera </span>
            </div>
            <div class="container-fluid">
                        ...
                        <tbody>
                            <?php foreach ($resultados as $posicion => $columna) { ?>
                                <tr style='<?= color_estado($miPDO, $columna["id_subvenciones"]); ?>'>
                                    ...
                                    <td class="align-middle p-0"><a class='<?= color_estado($miPDO, $columna["id_subvenciones"]).' '; ?> text-decoration-none' href='includes/templates/detalles_subvencion.php?id_subvenciones=<?= $columna["id_subvenciones"]; ?>' ><div class="p-2 text-dark"><?= $columna['descripcion_subvenciones'] ?></div></a></td>
