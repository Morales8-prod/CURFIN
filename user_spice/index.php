                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-xl-3 mb-4 d-none d-sm-block">
                                            <div class="card shadow border-start-primary py-2">
                                                <div class="card-body">
                                                    <div class="row align-items-center no-gutters">
                                                        <div class="col mr-2">
                                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Número de Subvenciones</span></div>
                                                            <div class="text-dark fw-bold h5 mb-0"><span><?php $cabecera = contadores_select($miPDO); echo $cabecera['subvenciones'];?></span></div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-center no-gutters">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="text-dark fw-bold h5 mb-0"><span><?php $cabecera = contadores_select($miPDO); echo $cabecera['proyectos'];?></span></div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-center no-gutters">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="text-dark fw-bold h5 mb-0"><span><?php $cabecera = contadores_select($miPDO); echo $cabecera['definitiva'];?></span></div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-center no-gutters">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="text-dark fw-bold h5 mb-0"><span><?php $cabecera = contadores_select($miPDO); echo $cabecera['denegada'];?></span></div>
                                                        </div>
                                                        ...
                                                        <table id="tablaDinamica" class="table table-bordered table-hover">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="col-1 bg-secondary text-light text-center align-middle">Financ.</th>
                                                                    <th class="col-1 col-lg-1 bg-secondary text-light text-center align-middle">Organismo</th>
                                                                    ...
                                                                    <th class="col-1 bg-secondary text-light text-center align-middle">Proyecto</th>
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($resultados as $posicion => $columna) { ?>
                                                                    <tr style='<?= color_estado($miPDO, $columna["id_subvenciones"]); ?>'>
                                                                        ...
                                                                        <td class="text-center align-middle"><?= $columna['financiacion_organismo'] ?></td>
