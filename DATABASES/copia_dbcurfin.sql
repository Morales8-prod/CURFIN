...
-- Volcando estructura de base de datos para doqxqqul_curfin
CREATE DATABASE IF NOT EXISTS `doqxqqul_curfin` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `doqxqqul_curfin`;
...
CREATE TABLE IF NOT EXISTS `subvenciones` (
  ...
  `tipo de organismo` varchar(50) NOT NULL,
